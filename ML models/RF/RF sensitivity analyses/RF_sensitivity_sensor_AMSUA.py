...
### Remove AMSUA from training:
mask = X_train['sensor_3'] != 1
...
pickle_file_best = 'RF_best_sensitivity_amsua.pkl'

with open(pickle_file_best, 'wb') as f:
    pickle.dump(best_result_dict, f)

print("Best results saved in RF_best_sensitivity_amsua.pkl")
