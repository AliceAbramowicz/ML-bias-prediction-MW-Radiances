...
### Remove MWHS2 from training:
mask = X_train['sensor_73'] != 1
X_train = X_train[mask]
y_train = y_train[mask]
print("Shape of X_train after removing mwhs2:", X_train.shape)
...
pickle_file_best = 'RF_best_sensitivity_mwhs2.pkl'

with open(pickle_file_best, 'wb') as f:
    pickle.dump(best_result_dict, f)

print("Best results saved in RF_best_sensitivity_mwhs2.pkl")
